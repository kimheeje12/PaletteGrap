...
public class SearchFeedAdapter extends RecyclerView.Adapter<SearchFeedAdapter.ViewHolder> {
    ...
    public SearchFeedAdapter(Context context, List<FeedData> feedlist){
    ...
    private SearchFeedAdapter.OnItemClickListener mListener;

    public void setOnItemClickListener(SearchFeedAdapter.OnItemClickListener listener){
    ...
    @NonNull
    @Override
    public SearchFeedAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.item_searchfeed,parent,false);
        SearchFeedAdapter.ViewHolder vh = new SearchFeedAdapter.ViewHolder(view);
        return vh;

    }

    @Override
    public void onBindViewHolder(@NonNull SearchFeedAdapter.ViewHolder holder, int position) {
